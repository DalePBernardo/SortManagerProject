...
public class BubbleSortTest {
    ...
    @Test
    @DisplayName("Given an array of mixed negative and positive numbers, Bubble sort is expected to return a the sorted array")
    public void givenArrayOfMixedPositiveAndNegativeNumbers_BubbleSort_ReturnsTheArraySorted(){
